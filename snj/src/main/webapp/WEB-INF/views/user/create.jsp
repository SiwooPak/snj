...
<%@include file="../template/header.jsp"%>
	...
	<div id="jumbotron" class="container-fluid">
		<div class="jumbotron jumbotron-info"
			...
			<h1 class="bottombrand wow flipInX" style="font-family: Mrs Sheppards;">
				회원가입&nbsp;<span
					class="glyphicon glyphicon glyphicon-pencil"></span>
			</h1>
		</div>
	</div>
	<div class="container">
		<form id="joinFrm" method="post" action="./createUser" role="form">
				...
				<div class="form-group" style="margin-top: 5%;">
					...
					<div class="col-md-4">
						<input class="form-control" type="text" name="u_id" id="id"
							required="required" autofocus="autofocus" onkeyup="idCheck();" />
					</div>
					<p id="message"></p>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-2">
						<input class="form-control" type="text" id="sample6_postcode"
							required="required" name="postNum" readonly maxlength="4" />
					</div>
					<span class="col-md-2">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="hidden" id="userImage" name="userImage"
							required="required" value="default.png">
					</div>
				</div>

				<input type="hidden" id="flag" name="flag" value="false"> 
				<input type="hidden" id="flag1" name="flag1" value="false">
			</div>
		</form>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<input class="form-control" type="file" id="imageFile"
						name="imageFile" onchange="fn_upload()" /> 
					<input type="hidden"
